...
import Animated,{ Easing, Extrapolate, interpolate, useAnimatedStyle, useDerivedValue, useSharedValue, withDelay, withTiming } from "react-native-reanimated";
...
export default function ThirdScreen(){
    ...
    useEffect(()=>{
        setTimeout(()=>{
            boxPosX.value = withTiming(100,{
                duration:500,
                easing:Easing.bounce
            },()=>{
                boxPosY.value = withDelay(500,
                    withTiming(-100,{
                        duration:500,
                        easing:Easing.bounce
                    })
